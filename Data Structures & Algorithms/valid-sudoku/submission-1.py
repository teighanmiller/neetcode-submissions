class Solution:
    ...
    def isValidSudoku(self, board: List[List[str]]) -> bool:
        print(self.check_row(board))
        print(self.check_column(board))
        print(self.check_sub_box(board))
        return all([self.check_row(board), self.check_column(board), self.check_sub_box(board)])
